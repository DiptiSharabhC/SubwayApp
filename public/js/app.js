...
function updateCart(sandwich) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', sandwich).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var sandwich = JSON.parse(btn.dataset.sandwich);
    updateCart(sandwich);
  });
...
__webpack_require__(/*! C:\Subway\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Subway\resources\scss\app.scss */"./resources/scss/app.scss");
